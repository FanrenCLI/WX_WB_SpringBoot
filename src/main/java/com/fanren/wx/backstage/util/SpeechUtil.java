...
public class SpeechUtil {
    ...
    public static final String APP_ID = "15603691";

    public static final String API_KEY = "29sHNCAiH91YDOnwuyWHB6iu";

    public static final String SECRET_KEY = "9TQIolKt18TpUYaksxTCmwfyY8RM5ENt";
    ...
    public static void main(String[] args) throws IOException {
        ...
        String pcm = SpeechRecognition("d:/SpeechSynthesizer.pcm", "pcm");
